...
struct Metadata {
    ...
    std::optional<std::string> point_of_contact;
...
struct GeographicalExtent {
    ...
    GeographicalExtent(double min_x, double min_y, double min_z,
...
struct CityJSONFeature {
     ...
     */
    size_t CityObjectCount() const { return city_objects.size(); }
};
